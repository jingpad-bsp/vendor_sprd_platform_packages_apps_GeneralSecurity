...
public class DateCycleUtils {
    //cycle values
    public static final String KEY_DATA_CYCLE_SIM1 = "pref_data_cycle_sim1";
    ...
    public DataRestriction getDataFlowRestriction(Context context, int sim) {
        ...
        dt.dayRestriction = (long)(Float.parseFloat(v) * Contract.M2BITS);

        v = sharedPref.getString(DateCycleUtils.KEY_MONTH_TOTAL, "0");
        dt.monthRestriction = (long)(Float.parseFloat(v) * Contract.M2BITS);
        v = sharedPref.getString(DateCycleUtils.KEY_MONTH_LEFT_RESTRICT, "0");
        dt.monthleftRestriction = (long)(Float.parseFloat(v) * Contract.M2BITS);
        return dt;
    }
