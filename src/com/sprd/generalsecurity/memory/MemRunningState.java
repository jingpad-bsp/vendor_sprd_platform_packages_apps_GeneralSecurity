...
//    final InterestingConfigChanges mInterestingConfigChanges = new InterestingConfigChanges();
    ...
    public final Comparator<MemRunningState.MergedItem> mBackgroundComparator
        = new Comparator<MemRunningState.MergedItem>() {
            @Override
    ...
    public static class BaseItem {
        ...
        public Drawable loadIcon(Context context, MemRunningState state) {
    ...
    public static class ProcessItem extends BaseItem {
        ...
        public void ensureLabel(PackageManager pm) {
            ...
            //UNISOC: Bug 675507 java.lang.NullPointerException: Attempt to get length of null array
    ...
    public static MemRunningState getInstance(Context context) {
        synchronized (sGlobalLock) {
            if (sInstance == null) {
                sInstance = new MemRunningState(context);
            }
            return sInstance;
        }
    }

    private MemRunningState(Context context) {
