...
//    private FloatPanelView mFloatPanelView;
        ...
        public void handleMessage(Message msg) {
            ...
            if (mNetworkTrafficRateOld != null && mNetworkTrafficRateNew != null) {
                ...
                if (type == NetworkType.WIFI){
                    //UNISOC: bug1004892 in English and Traditional Chinese, WLAN should be 'Wi-Fi'
                    setCurrentSpeed(mContext.getResources().getString(R.string.wlan), rate);
    ...
    protected void stopRealSpeed() {
        mHandler.removeMessages(0);
        // UNISOC: Bug 705991 reset the network state and speed when close all network
        setCurrentSpeed(mContext.getResources().getString(R.string.current_speed_default), "0B/S");
    }
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        /**
         * UNISOC: Bug855142 In Chinese Networkless state, open the "Display real-time network speed"
         * menu, displaying "Current: 0B/S", switch to other languages, "Current" does not switch to
         * follow the system language.
         * @{
         */
        if (NetworkType.DISCONNECTED == TeleUtils.getCurrentNetworkType(mContext)){
            setCurrentSpeed(mContext.getResources().getString(R.string.current_speed_default), "0B/S");
        }
        /**
         * @}
