...
//                        Formatter.formatFileSize(NetworkRankActivity.this, mApps.get(position).usageSim1)));
//            } else {
...
//                    Formatter.formatFileSize(NetworkRankActivity.this, mApps.get(position).usageWifi)));
//            holder.flow_sum.setText(String.format(getResources().getString(R.string.data_flow_sum),
//                    Formatter.formatFileSize(NetworkRankActivity.this, mApps.get(position).usageSum)));
//            if (mDualSimRelease) {
//                holder.flow_data2.setText(String.format(getResources().getString(R.string.data_flow_data2),
//                        Formatter.formatFileSize(NetworkRankActivity.this, mApps.get(position).usageSim2)));
//            }
//
//            return convertView;
//        }
