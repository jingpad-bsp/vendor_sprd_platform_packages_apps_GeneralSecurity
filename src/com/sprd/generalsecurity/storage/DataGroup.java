    ...
    public boolean isDisplayIcon(int type) {
        ...
        switch (type) {
            ...
            case StorageManagement.TMP_ITEM:
                /** UNISOC: Bug 705066 there is no expand icon when has temp file */
