 ...
 * needed.
 */
public class OptimizeApplicationsState {
    ...
    public static OptimizeApplicationsState sInstance;

    public static OptimizeApplicationsState getInstance(Application app) {
        synchronized (sLock) {
            if (sInstance == null) {
                sInstance = new OptimizeApplicationsState(app);
            }
            return sInstance;
        }
    }
    ...
    private OptimizeApplicationsState(Application app) {
        mContext = app;
                ...
                case MSG_LOAD_ICONS: {
                    ...
                    synchronized (mEntriesMap) {
                        ...
                        for (int i=0; i<mAppEntries.size() && numDone<2; i++) {
                            ...
                            /* UNISOC: Bug1033726 entry is null in monkey test @{ */
                            if (entry == null) {
                                Log.w(TAG, "Cannot find entry");
                                continue;
                            }
                            /* @} */
    ...
    public static final AppFilter FILTER_GAMES = new AppFilter() {
        ...
        @Override
        public boolean filterApp(OptimizeApplicationsState.AppEntry info) {
